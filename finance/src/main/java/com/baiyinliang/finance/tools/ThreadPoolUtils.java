...
public class ThreadPoolUtils {
     ...
     */
    public static void execute(Runnable runnable, Integer customNum) {
        getThreadPool(customNum).execute(runnable);
    }
     ...
     */
    public static <T> Future<T> submit(Callable<T> callable, Integer customNum) {
        return getThreadPool(customNum).submit(callable);
    }

    public static synchronized ThreadPoolExecutor getThreadPool(Integer customNum) {
        if (threadPool == null) {
            // 获取处理器数量
